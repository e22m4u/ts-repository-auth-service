...
- [Предварительная настройка](#предварительная-настройка)
  ...
  - [2. Определение моделей](#2-определение-моделей)
...
приложения с аутентификацией. Каждый следующий фрагмент кода является логическим
продолжением предыдущего. В примерах используется маршрутизатор
...
class UserModel extends BaseUserModel {
  ...
  // чтобы быть универсальной; добавление поля `username` определяет,
  // что в данном приложении пользователи будут идентифицироваться
  // именно по этому уникальному имени
  @property({
...
для выполнения ключевых операций. Разработчик самостоятельно определяет
логику своего приложения, используя инструменты данного модуля и примеры,
